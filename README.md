# CoChem-EVAL: Statistical Evaluation & Metrics
...
Evaluates computational performance against experimental benchmarks.
...
Calculates RMSD, Mean Absolute Errors (MAE), and robust statistical dispersion metrics for large-scale PES mappings.
...
```bash
cochem-eval --dataset S66x8 --method wB97M-V
```
...
pipeline.run(target_module="CoChem-EVAL")
```
